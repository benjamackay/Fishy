...
\begin{itemize}[leftmargin=1.5cm]
  ...
  \\ \textit{Consecuencia: Otto anota firme: ``¡Brillante! Ningún regalo vale poner en riesgo la privacidad de tu hogar. ¡Camino desbloqueado!'' Otto encuentra la pieza auténtica siguiendo las huellas legítimas en los árboles junto a Pudú y Huemul.}
...
\begin{itemize}
  ...
  \\ $\rightarrow$ \textit{Pista en libreta de Otto: Flamenco dice que la brújula se hundió en el fango por culpa de alguien muy despistado, pero no aporta detalles directos.}
  ...
  \\ $\rightarrow$ \textit{Pista en libreta de Otto: Pato Juarjual admite que solo reenvía lo que leyó en el chat, sin haber visto el hecho.}
  ...
  \\ $\rightarrow$ \textit{Pista en libreta de Otto: Coipo entrega datos precisos y un registro en su libreta que contradice la versión del fango.}
\end{itemize}
...
\vspace{1em}
\textbf{Puntaje HDU03} (recorrido completo de Misiones 3 y 4, considerando la ramificación):\\
\textbf{Máximo:} \textbf{+7 pts} (M3 óptima $+2$; M4 fase 1 básica $+1$ $\rightarrow$ segunda decisión $+2$ $\rightarrow$ fase 2 óptima $+2$)\\
\textbf{Mínimo:} \textbf{$-$4 pts} (todas las rutas inseguras, sin rectificar)

\medskip
\noindent\footnotesize\textit{Nota de diseño: en la Misión 4 la ruta ``básica $+$ segunda decisión'' ($+3$) supera a la
óptima directa ($+2$). Es lo que especifica el documento de diálogos; se deja constancia por si el
equipo desea revisar el balance de incentivos.}\normalsize
...
\vspace{1em}
\textbf{Puntaje HDU02} (recorrido completo de Misiones 1 y 2, considerando la ramificación):\\
\textbf{Máximo:} \textbf{+5 pts} (M1: $+2$ y cierre $+1$; M2: $+2$ directo)\\
\textbf{Mínimo:} \textbf{$-$4 pts} (ambas misiones por la ruta insegura sin corregir)
